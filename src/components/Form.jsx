      ...
      <div className="relative px-4 py-10 bg-white mx-8 md:mx-0 shadow-lg rounded-3xl sm:p-10">
        <div className="max-w-md mx-auto">
          ...
          <div className="flex justify-center w-full items-center">
            <div>
              <button onClick={google} className="flex items-center justify-center py-2 px-20 bg-white hover:bg-gray-200 focus:ring-blue-500 focus:ring-offset-blue-200 text-gray-700 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg">
                <svg
                  viewBox="0 0 24 24"
                  height="25"
                  width="25"
                ...
                <a  className="ml-2">Sign in with Google</a>
              </button>
              <button onClick={facebook} className="flex items-center justify-center py-2 px-20 bg-white hover:bg-gray-200 focus:ring-blue-500 focus:ring-offset-blue-200 text-gray-700 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg mt-4">
              <svg
                viewBox="0 0 30 30"
                height="30"
                width="30"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path d="M15 0C6.716 0 0 6.716 0 15c0 7.53 5.517 13.742 12.733 14.848v-10.49H9.153v-4.358h3.58V10.63c0-3.539 2.162-5.475 5.319-5.475 1.512 0 2.813.113 3.191.164v3.698l-2.188.001c-1.715 0-2.048.815-2.048 2.012v2.641h4.095l-.533 4.358h-3.563v10.49C24.482 28.742 30 22.53 30 15c0-8.284-6.716-15-15-15z" fill="#1877F2" />
              </svg>
